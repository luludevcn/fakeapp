  ...
  return (
    <SafeAreaView style={styles.container}>
      <ScrollView showsVerticalScrollIndicator={false}>
        {/* 订单状态 */}
        <View style={[styles.statusContainer, { backgroundColor: '#FFF3E0' }]}>
          <Ionicons name="time-outline" size={24} color="#FF6B00" />
          <Text style={[styles.statusText, { color: '#FF6B00' }]}>{order.status}</Text>
          <Text style={styles.statusSubtext}>正在为您寻找司机...</Text>
        </View>
